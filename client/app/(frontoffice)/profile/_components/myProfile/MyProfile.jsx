              ...
              <div className="space-y-10">
                ...
                >
                  ...
                  <div className="relative p-6 sm:p-10 flex flex-col md:flex-row items-center md:items-end gap-10">
                    ...
                    >
                      <Button className="w-full md:w-auto h-16 px-10 rounded-4xl bg-primary text-white font-black uppercase tracking-widest shadow-2xl shadow-primary/20 hover:bg-primary/90 transition-all gap-3 border-none">
                        <Iconify
                    ...
                    <Card className="h-full bg-white rounded-4xl sm:rounded-[2.5rem] shadow-xl shadow-gray-200/30 border border-gray-100 overflow-hidden">
                      <CardContent className="p-6 sm:p-10 space-y-8">
                        <div className="flex items-center justify-between">
                          ...
                          <Link href={`/profile/updateaddress`}>
                            <Button
                              variant="ghost"
                              size="icon"
