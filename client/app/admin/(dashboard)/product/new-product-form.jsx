...
function NewProductForm({ onSave, onCancel, open, onClose }) {
  ...
  const {
    ...
    defaultValues: {
      sku: "",
      product_name: { en: "", fr: "", ar: "" },
      subcategory_id: "",
      short_description: { en: "", fr: "", ar: "" },
      long_description: { en: "", fr: "", ar: "" },
      price: 0,
      discount_price: 0,
      quantity: 0,
      option: "",
              ...
              <TabsContent value="general" className="mt-0 space-y-6">
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                  ...
                  <div className="lg:col-span-1 space-y-6">
                    <div className="flex flex-col items-center justify-center p-6 bg-gray-50/50 border border-dashed border-gray-200 rounded-3xl min-h-75">
                            ...
                            return (
                              ...
                              >
                                ...
                                <Button
                                  ...
                                  className="absolute -top-2 -right-2 h-7 w-7 rounded-full bg-destructive text-white p-0 opacity-0 group-hover:opacity-100 transition-all shadow-lg hover:scale-110"
                                >
                                  <Iconify
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                              ...
                              <SelectContent>
                                {subcategories.map((sc) => (
                                  <SelectItem key={sc._id} value={sc._id}>
                                    {t(sc.subcategory_name[currentLanguage])}
                                  </SelectItem>
                                ))}
                              </SelectContent>
                            </Select>
                      ...
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          className={errors.option ? "border-destructive" : ""}
                        />
                      </div>
                    </div>
