...
import { deleteCoupon } from "@/store/slices/admin/couponSlice";
    ...
    try {
      ...
      const snackbarMessage =
        selected.length === 1
          ...
          : `${t("Selected")} ${selected.length} ${t("coupons are deleted")}`;

      toast.success(snackbarMessage);
    } catch (error) {
      console.error("Error deleting coupons:", error);
      toast.error(t("Error deleting coupons"));
    } finally {
          ...
          <div className="flex-1 max-w-md">
            <div className="relative w-full">
              ...
              <Input
                ...
                placeholder={t("Search for Coupon...")}
