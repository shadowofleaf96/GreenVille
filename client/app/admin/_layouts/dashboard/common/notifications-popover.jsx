    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        ...
        >
          ...
          />
          {unreadCount > 0 && (
            <Badge className="absolute -top-1 -right-1 min-w-4.5 h-4.5 flex items-center justify-center p-0.5 bg-red-500 text-white font-black text-[10px] ring-2 ring-white">
