...
const Product = memo(({ product, onQuickView }) => {
  ...
  return (
    <div className="group relative bg-white rounded-4xl border border-gray-100 hover:border-primary/20 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/5 flex flex-col h-full overflow-hidden">
